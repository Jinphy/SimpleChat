...
abstract class BaseApi<T> implements ApiCallback<T>, ApiInterface<T> {
    ...
    protected static ExecutorService threadPool = ThreadPoolUtils.threadPool;
    ...
    protected Api.Data dataType;                           // 枚举，表示response中data字段的类型
    //====================方法===============================================
    ...
    protected void init() {
         ...
         *      @see Api.Data
         *      @see BaseApi#dataType(Api.Data, Class<U>)
     ...
     */
    @Override
    public ApiInterface<T> dataType(Api.Data dataType, Class<?>... dataClass) {
